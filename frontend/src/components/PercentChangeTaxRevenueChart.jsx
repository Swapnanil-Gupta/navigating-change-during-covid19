...
export default function PercentChangeTaxRevenueChart({
  stateCode,
  includedCategories,
  startYear,
  endYear,
  ...
  const { isLoading, isError, data, error } = useTaxData({
    stateCode,
    includedCategories,
    startYear,
    endYear,
  ...
  const chartOptions = {
    ...
    vAxes: {
      0: {
        title: "Change in Percentage of Total Revenue from Last Year (%)",
        viewWindow: {
          min: viewWindowMin,
          max: viewWindowMax,
        },
  ...
  return (
    <div>
      <h3 className="text-2xl font-semibold">
        Growth/Decline in Percentage of Total Tax Revenue Compared to Previous
        Year by Tax Category in the State
      </h3>
