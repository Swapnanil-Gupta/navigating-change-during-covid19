import useEntrepreneurshipData from "@/hooks/useEntrepreneurshipData";
...
export default function PercentBusinessEstablishmentsChart({
  ...
  const { isLoading, isError, data, error } = useEntrepreneurshipData({
    stateCode,
    industryCode,
    includedSizes,
    startYear,
  ...
  const chartOptions = {
    ...
    vAxes: {
      0: {
        title: "Change in no. of Business Establishments",
        viewWindow: {
          min: viewWindowMin,
          max: viewWindowMax,
        },
  ...
  return (
    <div>
      <h3 className="text-2xl font-semibold">
        Growth/Decline in number of Business Establishments Compared to Previous
        Year for the Industry in the State
      </h3>
